	...
	<div class="top">
    	<div class="top_center">
            <ul class="top_bars">
                ...
                <li><a href="ToIndexServlet">回到首页<span class="jt_down"></span></a></li>
            </ul>
        </div>
    </div>
    <!--头部-->
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <img src="${entry.value.book.image }" width="40px" height="40px">
                                 <span>
 ...
 -->
             <!-- <div class="bb">
                ...
                <div class="allButtom">
                    ...
                    <span>已选择<font>${car.size }</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价(不含运费)：<font>¥${car.cost}元</font></span>
                </div>
		</div>
	</div>
</div>
