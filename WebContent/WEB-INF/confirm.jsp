...
<script type="text/javascript">
	...
	function submitForm1(){
	    document.getElementById("form1").action="addAddress";
	    document.getElementById("form1").submit;
	}
	
	//跳转到orderlist页面
	function submitForm2(){
		document.getElementById("form1").action="orderList";
	    document.getElementById("form1").submit;
	}
...
<body>
    ...
    <div class="content">
		...
		<form action="orderlist.html" name="orderForm" id="form1">
    		...
    		<div class="centerTop">
    			...
    			<p id="newAdres" style="font-size:15px;display: none;">
					...
					<input type="submit" value="保存" onclick="submitForm1()">
				</p>
    		</div>
    		...
    		<div class="money">
    			<span><font>${car.size }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.cost}</span>
    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

    			<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.cost }</span>
    		</div>
    		<div class="submit">
    			<span>应付金额：<font>¥${car.cost}</font><input type="image" src="images/21_03.png" onclick="submitForm2()"></span>
    		</div>
			</form>
    	</div>
